...
import (
	...
	scalebase "github.com/iwahbe/terraform-provider-scalebase/provider"

	"github.com/kzmake/pulumi-scalebase/provider/pkg/version"
)
...
const (
	...
	mainPkg = "scalebase"
	// modules:
	mainMod = "index" // the scalebase module
)

//go:embed cmd/pulumi-resource-scalebase/bridge-metadata.json
var metadata []byte
...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		//
		//    - In provider/cmd/pulumi-tfgen-scalebase/main.go, replace the
		...
		//
		//    - In provider/cmd/pulumi-resource-scalebase/main.go, replace the
		...
		//
		//      	tfbridge.Main(context.Background(), "scalebase", scalebase.Provider(),
		...
		// convention is to have a function at "github.com/iwahbe/terraform-provider-scalebase/provider".New
		...
		//
		//nolint:lll
		P: shimv2.NewProvider(scalebase.New(version.Version)()),
		...
		Keywords:   []string{"kzmake", "scalebase", "category/cloud"},
		License:    "Apache-2.0",
		...
		Golang: &tfbridge.GolangInfo{
			ImportBasePath: path.Join(
				"github.com/kzmake/pulumi-scalebase/sdk/",
	...
	prov.MustComputeTokens(tokens.SingleModule("scalebase_", mainMod,
